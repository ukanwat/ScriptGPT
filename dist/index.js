...
var buildPromptString = (description, inputTypes, outputType) => {
...
var saveFunctionToFile = async (functionName, functionCode, isTypescript) => {
  var outputFolderPath = import_app_root_path.default + "/generated";
  console.log("existsSync:", import_fs_extra.default.existsSync(outputFolderPath));
  var filePath = import_app_root_path.default + `/generated/${functionName}.${isTypescript ? "ts" : "js"}`;
...
var generateFunction = async (functionName, description, parameters, returnType, isTypescript) => {
  const prompt = buildPromptString_default(description, parameters, returnType);
  try {
...
var import_app_root_path2 = __toESM(require("app-root-path"));
var import_cosmiconfig = require("cosmiconfig");
async function generator(generateAll) {
  if (!import_fs_extra2.default.existsSync(import_app_root_path2.default + "/generated")) {
    import_fs_extra2.default.mkdirSync(import_app_root_path2.default + "/generated");
  }
  var isTypescript = import_fs_extra2.default.existsSync(import_app_root_path2.default + "/tsconfig.json");
  ...
  try {
    ...
    for (const value of jsonData.functions) {
      ...
      var outputPath = import_app_root_path2.default + "/generated/" + value.name + ".js";
      if (import_fs_extra2.default.existsSync(outputPath) && generateAll === false) {
      ...
      generateFunction(
        value.name,
        value.description,
        value.parameters.map((element) => JSON.stringify(element)),
        value.return,
        isTypescript
      );
      generatedFunctions.push(value.name);
  ...
  console.log(generatedFunctions);
  var functionsFilePath = import_app_root_path2.default + `/generated/functions.${isTypescript ? "ts" : "js"}`;
  var fullCode = "";
